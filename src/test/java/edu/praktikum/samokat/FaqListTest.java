...
// здесь будет параметризированный тест

@RunWith(Parameterized.class)
public class FaqListTest extends AllTests {
    ...
    //Конструктор класса
    public FaqListTest(String questionLocator, String answerLocator, String answerText) {
