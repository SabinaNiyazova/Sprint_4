package edu.praktirum.samokat.pom;
...
public class OrderInfo {
    ...
    public OrderInfo sendRentalDate(String date) {
    ...
    //Ввод срока аренды
    public OrderInfo setRentalTime() {
